...
export default function AdminPanelPage() {
    ...
    const handleUpdatePlan = async (userId, newPlan, days) => {
        ...
        try {
            const res = await csrfFetch(
                `${API_BASE}/admin/users/update-plan`,
                {
                    method: 'POST',
                    headers: {
    ...
    const handleToggleAdmin = async (userId, currentIsAdmin) => {
        ...
        try {
            const res = await csrfFetch(
                `${API_BASE}/admin/users/toggle-admin`,
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const handleUpdateAd = async () => {
        const res = await csrfFetch(
            `${API_BASE}/admin/ads/${editingAd.id}`,
            {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        Manage registered users, control subscription
                        plans, and monitor SaaS platform analytics.
                    </p>
