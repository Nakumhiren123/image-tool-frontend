        ...
        <div style={{ padding: '24px 28px', background: '#FAFBFD' }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ fontWeight: 800, fontSize: '0.82rem', color: '#0F172A', marginBottom: 2 }}>
                Upgrade to PicCraft PRO
              </p>
              <p style={{ fontSize: '0.72rem', color: '#64748B', lineHeight: 1.4 }}>
                Skip ads forever and unlock premium processing features.
              </p>
            </div>
            <button
