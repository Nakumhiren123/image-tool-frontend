...
const ALLOWED_TARGETS = {
  jpg: ['png', 'jpeg', 'webp', 'avif', 'gif', 'bmp', 'pdf', 'ico'],
  png: ['jpg', 'jpeg', 'webp', 'avif', 'gif', 'bmp', 'pdf', 'ico'],
  jpeg: ['jpg', 'png', 'webp', 'avif', 'gif', 'bmp', 'pdf', 'ico'],
  webp: ['jpg', 'jpeg', 'png', 'avif', 'gif', 'bmp', 'ico'],
  avif: ['jpg', 'jpeg', 'png', 'webp', 'ico'],
  gif: ['jpg', 'jpeg', 'png', 'webp', 'ico'],
  bmp: ['jpg', 'jpeg', 'png', 'webp', 'ico'],
  heic: ['ico', 'jpg', 'jpeg', 'png', 'webp'],
};
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div className="format-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10 }}>
        {(from
          ? FORMATS.filter((f) => ALLOWED_TARGETS[from]?.includes(f.id))
          : FORMATS.filter((f) => f.id !== 'docx')
        ).map((f) => {
